...
-- dmenu
  awful.key({ modkey }, "r",
    function() awful.spawn(string.format("dmenu_run -i -nb '#191919' -nf '#fea63c' -sb '#fea63c' -sf '#191919' -fn NotoMonoRegular:bold:pixelsize=14"
        ,
  ...
  awful.key({ modkey }, "t", function() awful.spawn("alacritty -e htop") end,
    { description = "Open htop", group = "function keys" }),
  ...
  awful.key({ modkey, modkey1 }, "/", function() awful.util.spawn("rofi -show drun") end,
    { description = "rofi", group = "function keys" }),
  awful.key({ modkey }, "o", function() awful.util.spawn(editorgui) end,
    { description = "run gui editor", group = "function keys" }),

  -- Screen (app arandr)
  -- Just Lap Screen
  awful.key({ modkey, modkey1 }, "0",
    function() awful.spawn.with_shell("source ~/.screenlayout/lap.sh") end,
    { description = "Just Lap", group = "Screen" }),
  -- Monitor Vertical x Lap Screen
  awful.key({ modkey, modkey1 }, "9",
    function() awful.spawn.with_shell("source ~/.screenlayout/monitorv_lap.sh") end,
    { description = "MonitorV x Lap", group = "Screen" }),
  -- Just External Vertical Screen
  awful.key({ modkey, modkey1 }, "8",
    function() awful.spawn.with_shell("source ~/.screenlayout/monitorv.sh") end,
    { description = "Just MonitorV", group = "Screen" }),
  -- Monitor x Lap Screen
  awful.key({ modkey, modkey1 }, "7",
    function() awful.spawn.with_shell("source ~/.screenlayout/monitor_lap.sh") end,
    { description = "Monitor x Lap", group = "Screen" }),

  -- Wallpapers ...
  awful.key({ modkey }, "i",
    function() awful.spawn.with_shell("nitrogen --save --head=0 ~/Pictures/Wallpapers/") end,
    -- function() awful.util.spawn("nitrogen") end,
    { description = "Nitrogen", group = "Wallpaper" }),
  awful.key({ altkey }, ".",
    -- function() awful.spawn.with_shell("nitrogen --set-zoom --random --head=0 ~/Pictures/Wallpapers/") end,
    function() awful.spawn.with_shell("nitrogen --set-zoom --random --save --head=0 ~/Pictures/Wallpapers/") end,
    { description = "Laptop", group = "Wallpaper" }),
  awful.key({ altkey }, ",",
    function() awful.spawn.with_shell("nitrogen --set-zoom --random --save --head=1 ~/Pictures/Wallpapers/") end,
    { description = "Monitor", group = "Wallpaper" }),
  ...
  awful.key({ modkey, modkey1 }, "c", function() awful.util.spawn("killall conky") end,
    { description = "conky killall", group = "function keys" }),
  awful.key({ modkey }, "F1", function() awful.util.spawn("rofi-theme-selector") end,
  ...
  awful.key({ modkey1, altkey }, "w", function() awful.util.spawn("arcolinux-welcome-app") end,
    { description = "ArcoLinux Welcome App", group = "ctrl+alt" }),
  awful.key({ modkey1, altkey }, "e", function() awful.util.spawn("archlinux-tweak-tool") end,
    { description = "ArcoLinux Tweak Tool", group = "ctrl+alt" }),
  awful.key({ modkey1, altkey }, "space",
    function() awful.spawn.with_shell("$HOME/.config/awesome/scripts/picom-toggle.sh") end,
    { description = "Picom toggle", group = "ctrl+alt" }),
  ...
  awful.key({ altkey }, "Tab", function() awful.client.focus.history.previous()
    ...
    { description = "goback", group = "client" }),
  ...
  -- Standard program
  awful.key({ modkey, modkey1 }, "Return", awesome.restart,
    { description = "reload awesome", group = "awesome" }),
  awful.key({ modkey, modkey1 }, "r", awesome.restart,
    { description = "reload awesome", group = "awesome" }),

  -- Tag browsing with modkey
  awful.key({ modkey, modkey1 }, "h", awful.tag.viewprev,
    { description = "view previous", group = "tag" }),
  awful.key({ modkey, modkey1 }, "l", awful.tag.viewnext,
    { description = "view next", group = "tag" }),
  awful.key({ modkey, }, "u", awful.tag.history.restore,
    { description = "go back", group = "tag" }),

  -- Volume
  awful.key({ modkey1, "Shift" }, "=", function() awful.spawn("/home/andreneji/.config/Scripts/Notify/volume+") end,
    { description = "Up Vol", group = "audio" }),
  awful.key({ modkey1, "Shift" }, "-", function() awful.spawn("/home/andreneji/.config/Scripts/Notify/volume-") end,
    { description = "Down Vol", group = "audio" }),
  awful.key({ modkey1, "Shift" }, "8", function() awful.util.spawn("pavucontrol") end,
    { description = "pulseaudio control", group = "audio" }),
  ...
  awful.key({ modkey, "Shift" }, "space", function() awful.layout.inc(1) end,
    { description = "select layout", group = "manipulation" }),

  awful.key({ modkey, "Shift" }, "k", function() awful.client.swap.byidx(1) end,
    { description = "swap with next client by index", group = "manipulation" }),
  awful.key({ modkey, "Shift" }, "j", function() awful.client.swap.byidx(-1) end,
    { description = "swap with previous client by index", group = "manipulation" }),
  ...
  awful.key({}, "XF86MonBrightnessDown", function() os.execute("xbacklight -dec 10") end,
    { description = "-10%", group = "hotkeys" }),
  awful.key({ modkey, "Shift" }, "=", function() os.execute("xbacklight -inc 10") end,
    { description = "+10%", group = "hotkeys" }),
  awful.key({ modkey, "Shift" }, "-", function() os.execute("xbacklight -dec 10") end,
    { description = "-10%", group = "hotkeys" }),
  ...
  awful.key({ modkey1, "Shift" }, "9",
    function()
      os.execute(string.format("amixer -q set %s 100%%", beautiful.volume.channel))
      beautiful.volume.update()
    end, { description = "Max Vol", group = "audio" }),

  awful.key({ modkey1, "Shift" }, "0",
    function()
      os.execute(string.format("amixer -q set %s 0%%", beautiful.volume.channel))
      beautiful.volume.update()
    end, { description = "Min Vol", group = "audio" }),
  ...
  awful.key({ modkey1, altkey }, "/", function() awful.util.spawn(terminal) end,
    { description = "open terminal", group = "terminal" }),

  -- Copy primary to clipboard (terminals to gtk)
  awful.key({ modkey }, "c", function() awful.spawn.with_shell("xsel | xsel -i -b") end,
    { description = "copy terminal to gtk", group = "terminal" }),
  -- Copy clipboard to primary (gtk to terminals)
  awful.key({ modkey }, "v", function() awful.spawn.with_shell("xsel -b | xsel") end,
    { description = "copy gtk to terminal", group = "terminal" }),
...
--   { description = "toggle fullscreen", group = "client" }),
  ...
  awful.key({ modkey, modkey1 }, "space", function(c) c:move_to_screen() end,
    { description = "move to screen", group = "manipulation" }),
...
awful.rules.rules = {
  ...
  { rule = { class = "Thunar" },
    properties = { screen = 1, maximized = false, floating = false } },
...
-- ======================================
-- awful.spawn.with_shell("$HOME/.screenlayout/screen2.sh")
-- awful.spawn.with_shell("$HOME/.screenlayout/monitor_V_lap.sh.sh")
-- awful.spawn.with_shell("xset -dpms") -- Evita que a tela desligue
...
-- awful.key({ modkey, modkey1 }, "m", function(c) c.maximized_vertical = not c.maximized_vertical c:raise() end,
--   { description = "(un)maximize vertically", group = "client" }),
-- awful.key({ modkey, modkey1 }, "n", function(c) c.maximized_horizontal = not c.maximized_horizontal c:raise() end,
--   { description = "(un)maximize horizontally", group = "client" }),

-- awful.key({ modkey, modkey1 }, "Up", function(c)
--   if c.floating then
...
-- awful.key({ modkey, modkey1 }, "Down", function(c)
--   if c.floating then
--     c:relative_move(0, 0, 0, 10)
--   else
--     awful.client.incwfact(-0.025)
...
-- end,
--   { description = "Floating Resize Vertical +", group = "client" }),
-- awful.key({ modkey, modkey1 }, "Left", function(c)
--   if c.floating then
...
-- awful.key({ modkey, modkey1 }, "Right", function(c)
--   if c.floating then
--     c:relative_move(0, 0, 10, 0)
--   else
--     awful.tag.incmwfact(0.025)
...
--   { description = "Pamac Manager", group = "ctrl+alt" }),
...
--   function() awful.spawn.with_shell("variety -n  && wal -i $(cat $HOME/Pictures/Wallpapers)&") end
--   ,
...
--   function() awful.spawn.with_shell("variety -p  && wal -i $(cat $HOME/Pictures/Wallpapers)&") end
--   ,
...
-- awful.key({ "Shift", modkey1 }, "r", function() awful.spawn("/home/andreneji/.config/Scripts/Rofi/rofi-files") end,
...
-- awful.key({ modkey, modkey1 }, "x", function() awful.spawn("/home/andreneji/.config/Scripts/power-menu.sh") end,
--   { description = "Rofi power menu", group = "Personal launchers" }),
-- awful.key({ "Shift", modkey1 }, "m", function() awful.spawn("/home/andreneji/.config/Scripts/screenshot") end,
--   { description = "Screenshot", group = "Personal launchers" }),
-- awful.key({ "Shift", modkey1 }, "p",
--   function() awful.spawn("/home/andreneji/.config/Scripts/Rofi/srcscript-rofi") end,
